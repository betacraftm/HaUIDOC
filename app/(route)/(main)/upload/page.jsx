...
export const metadata = {
  ...
  description:
    "Tải lên tài liệu học tập của bạn để chia sẻ với cộng đồng sinh viên Đại học Công nghiệp Hà Nội. Hỗ trợ PDF, DOC, DOCX với dung lượng tối đa 10MB.",
  keywords:
    "tải lên, tài liệu, PDF, DOC, chia sẻ, HaUI, Đại học Công nghiệp Hà Nội",
};
